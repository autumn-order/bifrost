...
//!
//! These tests verify the len method's behavior including:
//! - Correct length reporting for empty queues
//! - Correct length reporting after adding jobs
//! - Correct length reporting after removing jobs
//! - Length does not count duplicates
...
#[tokio::test]
async fn test_len_after_multiple_pushes() {
    let redis = RedisTest::new().await.expect("Failed to create Redis test");
    let queue = setup_test_queue(&redis);
...
#[tokio::test]
async fn test_len_does_not_count_duplicates() {
    let redis = RedisTest::new().await.expect("Failed to create Redis test");
    let queue = setup_test_queue(&redis);
...
#[tokio::test]
async fn test_len_with_different_job_types() {
    let redis = RedisTest::new().await.expect("Failed to create Redis test");
    let queue = setup_test_queue(&redis);
...
#[tokio::test]
async fn test_len_after_mixed_operations() {
    let redis = RedisTest::new().await.expect("Failed to create Redis test");
    let queue = setup_test_queue(&redis);
...
#[tokio::test]
async fn test_len_after_schedule() {
    let redis = RedisTest::new().await.expect("Failed to create Redis test");
    let queue = setup_test_queue(&redis);
